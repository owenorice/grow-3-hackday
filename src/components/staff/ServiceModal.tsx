...
import { ShieldCheck, Wrench, X, CheckSquare, Square, History, AlertTriangle, User } from 'lucide-react';
...
export const ServiceModal: React.FC<ServiceModalProps> = ({
  ...
  const machine = propMachine || (machineId ? machines.find(m => m.id === machineId) : null);
  ...
  const handleSelectAll = () => {
    ...
    setChecklist({
      cables: shouldCheck,
      lubrication: shouldCheck,
      fasteners: shouldCheck,
      safetyStop: shouldCheck,
      sanitation: shouldCheck,
    });
  };
  ...
  return (
    ...
    >
      {/* Modal Container */}
      <div
        className="bg-black border-2 border-[#97D700] max-w-xl w-full p-6 sm:p-8 relative shadow-[0_0_60px_rgba(151,215,0,0.2)] text-white space-y-6 max-h-[92vh] overflow-y-auto"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label className="block text-[11px] font-black uppercase tracking-wider text-[#AAAAAA] mb-1 flex items-center gap-1">
