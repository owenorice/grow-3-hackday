...
| 👤 **Oliver** | **[#3 Filterable Equipment Directory & Pod Cards](https://github.com/owenorice/grow-3-hackday/issues/3)** | `P1-mvp` | `src/components/equipment/` | `feature/issue-3-equipment-list` |
